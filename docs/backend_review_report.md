...
| 编号 | 任务 | 目标文件 | 预期收益 |
|---|---|---|---|
| L1 | 引入 Provider/数据源注册表 | `ai/client_factory.py`、`data/factory.py` | 新增数据源/AI provider 无需改核心文件 |
...
| L5 | 经验库升级 | `records/experience_reader.py` | 从时间排序升级为 pattern + direction + 相似度排序 |
