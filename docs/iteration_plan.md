...
| P0 | L5 | curation/review/评估管道和 readiness 已建立；唯一 eligible 已有脱敏 record ID，但操作者选择 defer，经验目录仍为空 | 等待可核验 outcome，按 record ID 导入并补足至少两个 instrument group，使 preflight 通过，再生成 Recall/NDCG/fallback/stability 报告 |
