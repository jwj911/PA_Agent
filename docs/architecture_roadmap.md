...
> 最近验收：GitHub Actions run `30416289654`，`main@b7beeff` 的
...
重建 M3 基线和 M4 报告。M4 已收口，M5 可按独立原子切片执行。
