...
列表 API、Prompt 正文、JSON schema 和 golden 保持不变。后续完成 M3.3 GUI 显示名/ID/tooltip；
仍须按文档中的原子切片逐层推进，不得与多 Agent、Prompt 文本优化或经验库权重调整混在同一提交。
