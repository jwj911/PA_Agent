...
> 最近验收：GitHub Actions run `30471807472`，`main@ac549d0` 的
...
metrics 与 Stage 1/三种 Stage 2 组装摘要均与迁移前冻结值一致；完整本地和远端门禁通过前
不启动剩余 28 个模板的后续批次。
