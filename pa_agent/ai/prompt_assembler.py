...
from pa_agent.ai.stage1_prompt_builder import (
    ...
    render_simple_market_features_block,
)
from pa_agent.ai.stage2_guidance import (
...
class PromptAssembler:
    ...
    _render_simple_market_features_block = staticmethod(render_simple_market_features_block)
    _inject_market_features_block = staticmethod(inject_market_features_block)
    ...
    def _stage1_prompt_builder(self) -> Stage1PromptBuilder:
        return Stage1PromptBuilder(
            ...
            render_kline_table_fn=self._render_kline_table,
            render_kline_feature_table_fn=self._render_kline_feature_table,
            render_program_prefill_hint_fn=self._render_program_prefill_hint,
            render_market_features_block_fn=self._render_simple_market_features_block,
        )
    ...
    def _stage1_pattern_supplement(self) -> str:
        return self._stage1_prompt_builder()._stage1_pattern_supplement()

    _render_program_prefill_hint = staticmethod(render_program_prefill_hint)

    def _build_stage1_user_prompt(self, frame: KlineFrame, *, analysis_mode: str = "original") -> str:
        return self._stage1_prompt_builder().build_stage1_user_prompt(
            frame,
            analysis_mode=analysis_mode,
        )
    ...
    def _build_incremental_stage1_user_prompt(
        ...
        *,
        ...
        return self._stage1_prompt_builder().build_incremental_stage1_user_prompt(
            frame,
            previous_record,
            new_bar_count,
            analysis_mode=analysis_mode,
    ...
    def _build_incremental_stage1_continuation_user_prompt(
        ...
        *,
        ...
        return self._stage1_prompt_builder().build_incremental_stage1_continuation_user_prompt(
            frame,
            previous_record,
            new_bar_count,
            analysis_mode=analysis_mode,
    ...
    _render_trend_conflict_guidance = staticmethod(render_trend_conflict_guidance)
    _render_transition_guidance = staticmethod(render_transition_guidance)
    _parse_level_midpoint = staticmethod(parse_level_midpoint)
    _render_planned_limit_hint = staticmethod(render_planned_limit_hint)
